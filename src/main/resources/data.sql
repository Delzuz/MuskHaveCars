...
INSERT INTO CAR (CAR_NAME, DESCRIPTION, RANGE, CAR_SEGMENT_ID) VALUES ('Nissan Leaf', 'The Nissan Leaf stylized as LEAF, is a compact five-door hatchback battery electric vehicle (BEV) manufactured by Nissan', 320, 1);
...
INSERT INTO CAR (CAR_NAME, DESCRIPTION, RANGE, CAR_SEGMENT_ID) VALUES ('Volvo XC40', 'The XC40 Recharge doesn''t force you to choose between power and responsible driving. Just take your seat, select a gear and enjoy the comfort.', 460, 2);
